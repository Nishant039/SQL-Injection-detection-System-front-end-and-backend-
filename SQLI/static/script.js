...
function login(){
    ...
    $.ajax('/api/v1.0/storeLoginAPI/',{
      ...
      if (res['status'] == 'success'){
        $("#stat").html('<b>Successful Login (Safe attempt)</b>');
      }
      else if(res['status'] == 'SQL Injection Detected . Your IP will be Blocked !'){
        $("#stat").html('<b>SQL Injection Detected . Your IP will be Blocked ! </b>');
      }
      else{
        $("#stat").html('<b>Login Failed  (Safe attempt)</b>');
      }
